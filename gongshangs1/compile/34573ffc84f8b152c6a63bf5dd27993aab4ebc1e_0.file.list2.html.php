<?php
/* Smarty version 3.1.30, created on 2017-04-08 04:49:49
  from "C:\wamp\www\gongshangs1\template\index\list2.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58e84fcd66bce5_35877523',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '34573ffc84f8b152c6a63bf5dd27993aab4ebc1e' => 
    array (
      0 => 'C:\\wamp\\www\\gongshangs1\\template\\index\\list2.html',
      1 => 1491557424,
      2 => 'file',
    ),
  ),
...
function content_58e84fcd66bce5_35877523 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<div class="zmr_jplist">
			...
			<form action="index.php?m=index&f=art&a=showlistc" method="post">
				<div class="zmr_sousuo">
					...
					<div class="zmr_sousuo_bg"><a href="#"></a></div>
				</div>
			</form>
...
?>
					...
					<div class="zmr_floor_list_s  <?php if ($_smarty_tpl->tpl_vars['i']->value%3 == 2) {?>zmr_floor_list_lr<?php }?>">
						<!--移入效果开始-->
...
?>
					...
					<div class="zmr_floor_list_s  <?php if ($_smarty_tpl->tpl_vars['j']->value%3 == 2) {?>zmr_floor_list_lr<?php }?>">
						<!--移入效果开始-->
						<a href="index.php?m=index&f=art&a=showlistc&coid=<?php echo $_smarty_tpl->tpl_vars['v']->value['coid'];?>
">
							<div>课程名称：<?php echo $_smarty_tpl->tpl_vars['v']->value["title"];?>
